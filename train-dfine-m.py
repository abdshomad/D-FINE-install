#!/usr/bin/env python3
"""
Train D-FINE M (Medium) model on chicken detection dataset.

Usage:
    python train-dfine-m.py [--use-amp] [--seed SEED] [--resume PATH] [--tune PATH] [--test-only]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train D-FINE-M model on chicken detection dataset",
