#!/usr/bin/env python3
"""
Train D-FINE X (Extra-large) model on chicken detection dataset.

Usage:
    python train-dfine-x.py [--use-amp] [--seed SEED] [--resume PATH] [--tune PATH] [--test-only]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train D-FINE-X model on chicken detection dataset",
