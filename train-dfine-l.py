#!/usr/bin/env python3
"""
Train D-FINE L (Large) model on chicken detection dataset.

Usage:
    python train-dfine-l.py [--use-amp] [--seed SEED] [--resume PATH] [--tune PATH] [--test-only]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train D-FINE-L model on chicken detection dataset",
