#!/usr/bin/env python3
"""
Train D-FINE S (Small) model on chicken detection dataset.

Usage:
    python train-dfine-s.py [--use-amp] [--seed SEED] [--resume PATH] [--tune PATH] [--test-only]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train D-FINE-S model on chicken detection dataset",
